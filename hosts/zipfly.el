...
;; Guard org2web usage to avoid load-time errors if it's absent
(when (fboundp 'org2web-add-project)
  (org2web-add-project
   '("my-website"
...
;; Call it immediately, but only if file is present
(let ((stenkoll-file (expand-file-name "~/src/mine/emacs.d/site-lisp/stenkoll.el")))
